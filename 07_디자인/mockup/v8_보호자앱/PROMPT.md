...
1. `07_디자인/mockup/v8_보호자앱/HANDOFF.md` 읽어줘 — 전체 프로젝트 맥락, 디자인 시스템 규칙, v8.1 정보구조가 정리되어 있어.

2. 그 다음 핵심 파일 3개를 읽어줘:
   - `07_디자인/mockup/v8_보호자앱/g-guardian-live.html` (홈화면)
   - `07_디자인/mockup/v8_보호자앱/g02-ai-guide.html` (AI 케어 가이드)
   - `07_디자인/mockup/v8_보호자앱/g03-sotong.html` (소통 - 대화+알림)
